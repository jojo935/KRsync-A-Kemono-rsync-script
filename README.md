...
You can also edit the script to include the destination by default. This is done by changing the string after "dest" in the shell script. Remove the '', and add the destination of your choosing. That way, you don't have to add it every time.
```
